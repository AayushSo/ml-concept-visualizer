...
description: Prepare repo-aware Conventional Commit messages for ml-concept-visualizer and optionally complete the commit workflow. If nothing is staged, ask whether to stage all current changes first.
---
...
4. Interpret changes in repo context:
   - This repo is an educational ML and performance concept visualizer collection.
